            ...
            <div class="card card-info card-outline card-tabs">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="price" class="form-control" id="price" placeholder="Цена"  value="<?= $product[$key]['price'] ?>">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="old_price" class="required">Старая цена</label>
                            <input type="text" name="old_price" class="form-control" id="old_price" placeholder="Цена"  value="<?=$product[$key]['old_price']  ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="status" name="status" <?=$product[$key]['status'] ? 'checked' : ''   ?> >
                ...
                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="hit" name="hit" <?=$product[$key]['hit'] ? 'checked' : ''   ?>>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <?php if(isset($product[$key]['is_download'])): ?>
...
<!--                                    selected>--><?//= $product[$key]['download_name'] ?><!--</selected>-->
<!--                                </option>-->
<!---->
<!--                            --><?php //endif; ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-outline card-success">
                            ...
                            <div class="card-body">
                                <button class="btn btn-success" id="add-base-img" onclick="popupGalleryImage(); return false;">Загрузить</button>
                                <div id="gallery-img-output" class="upload-images base-image">
                        ...
                        <?php foreach (\fcs\App::$app->getProperty('languages') as $k => $lang): ?>
                            ...
                            <div class="tab-pane fade <?php if ($lang['base']) echo 'active show' ?>" id="<?= $k ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_description[<?= $lang['id'] ?>][title]" class="form-control" id="title" placeholder="Наименование категории" value="<?= h($product[$lang['id']]['title']) ?>" >
                                </div>

                                <div class="form-group">
                                    <label for="description">Мета-описание</label>
                                    <input type="text" name="product_description[<?= $lang['id'] ?>][description]" class="form-control" id="description" placeholder="Мета-описание" value="<?= h($product[$lang['id']]['description']) ?>">
                                </div>

                                <div class="form-group">
                                    <label for="keywords">Ключевые слова</label>
                                    <input type="text" name="product_description[<?= $lang['id'] ?>][keywords]" class="form-control" id="keywords" placeholder="Ключевые слова" value="<?= h($product[$lang['id']]['keywords']) ?>">
                                </div>

                                <div class="form-group">
                                    <label for="exerpt">Краткое описание</label>
                                    <input type="text" name="product_description[<?= $lang['id'] ?>][exerpt]" class="form-control" id="exerpt" placeholder="Ключевые слова" value="<?= h($product[$lang['id']]['exerpt']) ?>">
                                </div>

                                <div class="form-group">
                                    <label for="content">Описание товара</label>
                                    <textarea name="product_description[<?= $lang['id'] ?>][content]" class="form-control editor" id="content" rows="3" placeholder="Описание категории"><?= h($product[$lang['id']]['content']) ?></textarea>
                                </div>
